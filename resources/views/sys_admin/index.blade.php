      ...
      <div class="col-md-5 col-12">
        ...
        <div class="row mt-5">
          <div class="col-md-12 col-12">
            <p class="h4 text-muted d-inline"># Students</p> <span class="font-weight-bold h3 ml-3" style="color:#607d8b ">{{$students}}</span>
          </div>
          <div class="col-md-12 col-12">
            <p class="h4 text-muted d-inline"># Lecturers</p> <span class="font-weight-bold h3 ml-3" style="color:#607d8b ">{{$lecturers}}</span>
          </div>
        </div>
